...
VsOutput main(VsInput input)
{
	...
	// x
	output.uv0.xy = float32_t2(1.0f / size.x, 0.0f);
	output.uv1.xy = float32_t2(3.0f / size.x, 0.0f);
	output.uv2.xy = float32_t2(5.0f / size.x, 0.0f);
	output.uv3.xy = float32_t2(7.0f / size.x, 0.0f);
	output.uv4.xy = float32_t2(9.0f / size.x, 0.0f);
	output.uv5.xy = float32_t2(11.0f / size.x, 0.0f);
	output.uv6.xy = float32_t2(13.0f / size.x, 0.0f);
	output.uv7.xy = float32_t2(15.0f / size.x, 0.0f);
