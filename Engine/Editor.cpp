...
namespace Editor
{
	...
	void ShowState(Renderer*, SceneManager* sceneManager)
	{
		...
		case Editor::EditorState::kEdit:
			if (ImGui::ImageButton((void*)(intptr_t)mStartTex->GetHandleSRV()->mGPU.ptr, ImVec2(24.0f, 24.0f)))
			{
			...
			ImGui::SameLine();
			if (ImGui::ImageButton((void*)(intptr_t)mPauseTex->GetHandleSRV()->mGPU.ptr, ImVec2(24.0f, 24.0f)))
			{
				Editor::gEditorState = Editor::EditorState::kStop;
				sceneManager->InitActor();
				mIsDebugCamera = false;
			...
			ImGui::SameLine();
			if (ImGui::ImageButton((void*)(intptr_t)mStepTex->GetHandleSRV()->mGPU.ptr, ImVec2(24.0f, 24.0f)))
			{
		...
		case Editor::EditorState::kPlay:
			if (ImGui::ImageButton((void*)(intptr_t)mStopTex->GetHandleSRV()->mGPU.ptr, ImVec2(24.0f, 24.0f)))
			{
				Editor::gEditorState = Editor::EditorState::kEdit;
				sceneManager->Reset();
				mIsDebugCamera = true;
